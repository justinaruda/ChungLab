samples = ["A1KO_Mock_Up","A1KO_IFN_Up"]
comparisons = ["A1KO_Mock_Up_vs_A1KO_IFN_Up"]
tags = ["all_tags"]
annotations = ["ncbiRefSeq"] 
...
rule quantify:
	...
	resources:
		memory = get_memory
	shell:
		"python /home/hchunglab/tmp/snakemake_tmp/quantify_hitsclip_stats.py -b {input.bgzip} -a {params.annotation} {params.peaks} -o {output.quant} -x {output.bed} -l"
